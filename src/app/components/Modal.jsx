...
const Modal = ({ isOpen, onClose, company }) => {
  ...
  return (
    <div className="  top-20 right-5 w-full max-w-lg h-auto flex justify-center items-center bg-black bg-opacity-50 z-50">
      <div className="w-full max-w-lg bg-white p-8 rounded-t-lg shadow-md">
        ...
        <div className="flex items-center mb-4">
          ...
          <button className="bg-red-500 text-white px-3  top-auto bottom-auto py-auto mr-auto rounded-md">
            + Follow
          </button>
        </div>
